...
def fridge(T_sp, T_amb, A, B, x0):
    ...
    for i in t:
        ...
        foo, foo, nextStep = ctrl.lsim(sys, U, [0,1], values[1:3, i])
...
#T_sp = [T_sp[i] + 273. for i in range(len(T_sp))] # Convert to Kelvin
T_amb = [15.,15.,16.,17.,18.,19.,20.,20.,20.,21.,22.,23.,22.,21.,21.,21.,21.,20.,20.,20.,19.,18.,17.,16.]
#T_amb = [T_amb[i] + 273. for i in range(len(T_amb))] # Convert to Kelvin
...
test = fridge(T_sp, T_amb, A_cont, B_cont, [8.,8.,0.])
